...
import chikanomaze.composeapp.generated.resources.chicken1_back
...
import chikanomaze.composeapp.generated.resources.chicken2_back
...
import chikanomaze.composeapp.generated.resources.chicken3_back
...
import chikanomaze.composeapp.generated.resources.chicken4_back
            ...
            painter = painterResource(
                when (skinIndex) {
                    0 -> when (chickenFaceDirection) {
                        Direction.UP -> Res.drawable.chicken1_back
                    ...
                    1 -> when (chickenFaceDirection) {
                        Direction.UP -> Res.drawable.chicken2_back
                    ...
                    2 -> when (chickenFaceDirection) {
                        Direction.UP -> Res.drawable.chicken3_back
                    ...
                    3 -> when (chickenFaceDirection) {
                        Direction.UP -> Res.drawable.chicken4_back
